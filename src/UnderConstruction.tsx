    ...
    return (
        <div className="fixed inset-0 bg-black text-green-400 font-mono flex flex-col items-center justify-center px-4 text-center overflow-hidden">
            ...
            <div className="text-green-500 text-xs md:text-sm flex flex-col items-start bg-black/30 p-3 border border-green-400/20 rounded w-full max-w-md font-mono">
                <div className="mb-2">
                    <span className="opacity-70">{">"}</span> Initializing
                    components
                    <span
                ...
                <div className="mb-2">
                    <span className="opacity-70">{">"}</span> Loading system
                    modules
                    <span
                        className="animate-blink"
                ...
                <div className="mb-2">
                    <span className="opacity-70">{">"}</span> Establishing
                    network connection
                    <span
                        className="animate-blink"
                ...
                <div className="mb-2">
                    <span className="opacity-70">{">"}</span> Compiling
                    interface elements
                    <span
                        className="animate-blink"
                        style={{ animationDelay: "0s" }}
